...
#include "task.h"
#include "semphr.h"
extern void HostCanStack_create(void);
extern TaskHandle_t HostCanStack;
extern void MfcTask_create(void);
extern TaskHandle_t MfcTask;
extern void ControlTask_create(void);
extern TaskHandle_t ControlTask;
